function graphWithoutPeripheralLinks(jsondatavar, term, method, nodes) {
...
json = jsondatavar;
	...
	.enter().append("line")
		...
		.attr("stroke", "#C2C6D1")
		.attr("stroke-width", function(d) { if (d.source.index==0 || d.target.index==0) {return calcLinkSize(d.coefficient);} else {return 0;} })
